...
def graph():
    ...
    plt.savefig('Assignment2/energy/predator_prey_cooldown_energy_new.png')
    ...
    plt.savefig('Assignment2/energy/predator_prey_phase_plane_energy.png')


params_list = [[0.001, 1.0],[0.005, 1.0], [0.005, 0.5], [0.01, 0.5], [0.01,0.25]]
...
def run_simulation(params):
    ...
    def create_animal(images, simulation):
        ...
        animal.ENERGY_DECAY_RATE = params[0]
        animal.ENERGY_GAIN_FROM_EATING= params[1]
        return animal
...
outcome = run_simulation(params_list[3])
print(outcome)
print(params_list[3])
print()
# graph()
