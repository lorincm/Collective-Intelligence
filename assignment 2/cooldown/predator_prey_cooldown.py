...
def visual():
    ...
    plt.savefig('Assignment2/cooldown/predator_prey_cooldown_360.png')
...
def graph():
    ...
    plt.savefig('Assignment2/cooldown/predator_prey_cooldown_360_new.png')
    ...
    plt.savefig('Assignment2/cooldown/predator_prey_phase_plane_cooldown.png')
